...
public class EquipmentManager {
    ...
    /** Returns how many virtual/runtime slots are currently equipped. */
    public int getEquipmentCount(UUID uuid) {
        if (uuid == null) return 0;
        Map<EquipmentSlot, RPGItem> playerEquipment = equipment.get(uuid);
        return playerEquipment == null ? 0 : playerEquipment.size();
    }
